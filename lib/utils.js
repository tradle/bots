...
const rawTypeforce = require('typeforce')
...
function interpretWrapper (wrapper) {
  return {
    metadata: {
      message: omit(wrapper.message, ['object']),
      object: omit(wrapper.object, ['object'])
    },
    data: {
      message: wrapper.message.object,
      object: wrapper.message.object.object
    }
  }
}
